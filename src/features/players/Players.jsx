...
import {useFetchPlayersQuery} from"./PlayersSlice";
        ...
        {data.data.players.map((player) => (
          ...
          <div key={player.id} className="player-card">
            ...
            <div className="player-details">
              ...
              <p>{player.breed}</p> {/* Display the player's breed */}
              <p>{player.status}</p> {/* Display the player's status */}
            </div>
          </div>
        ))}
      </div>
